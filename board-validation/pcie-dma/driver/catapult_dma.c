...
#define CAT_APP_ABI_VERSION		0x100010
#define CAT_APP_HEARTBEAT		0x100020
#define CAT_APP_CAPABILITIES		0x100030
#define CAT_APP_RESET_COUNT		0x100040
#define CAT_APP_ERROR_COUNT		0x100050
#define CAT_APP_SCRATCH			0x100060
